...
namespace Models.Admission
{
  public class CaptchaImage
  {
    ...
    public void GenerateImage()
    {
      ...
      HatchBrush hatchBrush = new HatchBrush(HatchStyle.DarkVertical, Color.LightGray, Color.White);
      ...
      PointF[] points =
{
      ...
      // Draw the text.
      hatchBrush = new HatchBrush(HatchStyle.Shingle, Color.Red, Color.Red);
